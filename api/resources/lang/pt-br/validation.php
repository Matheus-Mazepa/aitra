...
return [
    ...
    */
    ...
    'email_is_not_client'       => 'Você não pode realizar compras com usuário cliente.',
    'is_type_image_valid'       => ':attribute possuí um formato inválido, os formatos aceitos são png, jpg e jpeg.',
    'validate_max_size'       => ':attribute deve ser menor do que 3MB.',
    'is_valid_money_value' => ':attribute possuí um valor inválido.',
    ...
    'custom_between'       => ':attribute deve estar entre :min e :max.',
    'verify_dimensions_sum'  => 'A soma das dimensões deve estar entre 29 e 200 cm',
    ...
    */
    ...
    'installments_bigger_than_value' => 'Valor total parcelado menor que valor do produto.',
    'vimeo_or_youtube' => 'O vídeo deve ser do Vimeo ou Youtube',
    'poly_exists' => 'Opção inválido',
    'password_changed' => 'A troca de senha é obrigatório no primeiro acesso',
    'is_valid_percent' => ':attribute deve ter porcentagens entre 0 e 100%',
    'verify_if_email_or_cpf_exits' => 'Um email com este cpf já cadastradado na plataforma',
    'value_bigger_than_min_value' => 'O valor minimo de produto, deve ser maior que o valor do desconto',
    'password_minimal_requirements' => 'A senha não atinge os requisitos mínimos de segurança. ' .
        '<br> Caracteres maiúsculos (A - Z)' .
        '<br> Caracteres minúsculos (a - z)' .
        '<br> Números (0 - 9)' .
    ...
    */
    ...
    'attributes' => [
        'project.name' => 'nome',
        'project.start_date' => 'data de inicio',
        'project.finish_date' => 'data de término',
        'activity.name' => 'nome',
        'activity.start_date' => 'data de inicio',
        'activity.finish_date' => 'data de término',
    ],
];
